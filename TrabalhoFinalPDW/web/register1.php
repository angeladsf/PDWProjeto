				 ...
				 <div class="register-top-grid">
					<h3>INFORMAÇÃO PESSOAL</h3>
					 ...
					 <div class="wow fadeInRight" data-wow-delay="0.4s">
						<span>Morada<label>*</label></span>
						<input type="text" name="morada" required> 
					 </div>
					 
					 <div class="clearfix"> </div>
					   <a class="news-letter" href="#">
						 <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i> </i>Receber a nossa Newsletter.</label>
					   </a>
					 </div>
				     <div class="register-bottom-grid">
						    <h3>INFORMAÇÃO PARA LOGIN</h3>
							 <div class="wow fadeInLeft" data-wow-delay="0.4s">
								...
								<input type="password" name ="psword1" required>
							 </div>
							 <div class="wow fadeInRight" data-wow-delay="0.4s">
